export const persianTexts={
    error:{
        register:{
            input:{
                phoneNumber:"لطفا یک شماره همراه معتبر وارد کنید",
                userName:"لطفا یک نام کاربری معتبر با طول 5 تا 15 کاراکتر وارد کنید",
                email:"لطفا یک ایمیل معتبر وارد کنید",
                password:"لطفا یک رمز عبور معتبر که شامل حداقل یک حرف بزرگ و یک حرف کوچک و یک عدد و یک کاراکتر خاص باشد وارد کنید",
                confirmPassword:"رمز عبور و تکرار آن یکسان نیستند",
