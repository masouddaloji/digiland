...
const ProductsCategory = Loadable(
  lazy(() => import("./Pages/ProductsCategory/ProductsCategory"))
);
const Product = Loadable(lazy(() => import("./Pages/Product/Product")));
const Cart = Loadable(
  lazy(() => import("./components/userBasket/userCart/Cart"))
);
const Favorite = Loadable(
  lazy(() => import("./components/userPanel/Favorite/Favorite"))
);
const CheckInformation = Loadable(
  lazy(() =>
    import("./components/userBasket/CheckInformation/CheckInformation")
  )
);
const SubmitOrder = Loadable(
  lazy(() => import("./components/userBasket/SubmitOrder/SubmitOrder"))
);
const MainAdmin = Loadable(
  lazy(() => import("./components/adminPanel/main/MainAdmin"))
);
const AdminProducts = Loadable(
  lazy(() => import("./components/adminPanel/AdminProducts/AdminProducts"))
);
const AdminUsers = Loadable(
  lazy(() => import("./components/adminPanel/AdminUsers/AdminUsers"))
);
const AdminOrders = Loadable(
  lazy(() => import("./components/adminPanel/AdminOrders/AdminOrders"))
);
const AdminArticles = Loadable(
  lazy(() => import("./components/adminPanel/AdminArticles/AdminArticles"))
);
const AddProduct = Loadable(
  lazy(() => import("./components/adminPanel/AddProduct/AddProduct"))
);
const EditProduct = Loadable(
  lazy(() => import("./components/adminPanel/EditProduct/EditProduct"))
);
const Orders = Loadable(
  lazy(() => import("./components/userPanel/Orders/Orders"))
);
const MainPanel = Loadable(lazy(() => import("./components/userPanel/main")));
const UserSetting = Loadable(
  lazy(() => import("./components/userPanel/UserSetting/UserSetting"))
);
const Address = Loadable(
  lazy(() => import("./components/userPanel/Address/Address"))
);
const AddArticles = Loadable(
  lazy(() => import("./components/adminPanel/AddArticles/AddArticles"))
);
const EditArticles = Loadable(
  lazy(() => import("./components/adminPanel/EditArticles/EditArticles"))
);
const Article = Loadable(lazy(() => import("./Pages/Article/Article")));
const WebLog = Loadable(lazy(() => import("./Pages/Articles/WebLog")));
const EditUser = Loadable(
  lazy(() => import("./components/adminPanel/EditUser/EditUser"))
);
const OrderInfo = Loadable(
  lazy(() => import("./components/userPanel/OrderInfo/OrderInfo"))
);
